...
var Artnet = function (config) {
    ...
    this.send = function (universe, refresh, callback) {
        ...
        //var buf = artdmxPackage(universe, refresh ? 512 : dataChanged[universe]); //TODO send always 512?
        var buf = artdmxPackage(universe, 512); //TODO workarund: send all values every time
